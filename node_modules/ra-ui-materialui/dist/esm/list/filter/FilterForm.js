...
import { FormGroupsProvider, SourceContextProvider, useListContext, useResourceContext, } from 'ra-core';
...
export var FilterForm = function (props) {
    ...
    var _a = useListContext(), setFilters = _a.setFilters, displayedFilters = _a.displayedFilters, filterValues = _a.filterValues;
...
export var FilterFormBase = function (props) {
    ...
    return (React.createElement(SourceContextProvider, { value: sourceContext },
