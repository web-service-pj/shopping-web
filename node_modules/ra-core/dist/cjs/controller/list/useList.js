...
var useList = function (props) {
    ...
    var _j = (0, util_1.useSafeSetState)(isFetching), fetchingState = _j[0], setFetchingState = _j[1];
    var _k = (0, util_1.useSafeSetState)(isLoading), loadingState = _k[0], setLoadingState = _k[1];
    var _l = (0, util_1.useSafeSetState)(isPending), pendingState = _l[0], setPendingState = _l[1];
    var _m = (0, util_1.useSafeSetState)(function () { return ({
        data: data,
    ...
    var _r = (0, util_1.useSafeSetState)({}), displayedFilters = _r[0], setDisplayedFilters = _r[1];
    var _s = (0, util_1.useSafeSetState)(filter), filterValues = _s[0], setFilterValues = _s[1];
