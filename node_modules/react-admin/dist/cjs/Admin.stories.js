...
exports.AccessControl = exports.CustomError = exports.DefaultError = exports.SubPath = exports.InsideRouter = exports.Basic = void 0;
...
var AccessControl = function () {
    ...
    var _a = React.useState(readerPermissions), permissions = _a[0], setPermissions = _a[1];
    var authProvider = {
        // authentication
        login: function () {
    ...
    return (React.createElement(Admin_1.Admin, { dataProvider: dataProvider, authProvider: authProvider, layout: CustomLayout },
