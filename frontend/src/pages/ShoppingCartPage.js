...
const ShoppingCartPage = () => {
  ...
  // 쿠폰 할인 계산 함수
  const calculateCouponDiscount = (price, couponCode) => {
    switch (couponCode) {
      case 'SAVE10':
  ...
  const calculateTotal = (items) => {
    ...
    setTotalPrice(total);
    // 쿠폰 할인도 재계산
    const newDiscount = calculateCouponDiscount(total, couponCode);
  ...
  const handleCouponChange = (e) => {
    ...
    const discount = calculateCouponDiscount(totalPrice, selectedCoupon);
           ...
           <div className="bg-white rounded-lg shadow-md">
             <div className="p-6">
               ...
               <div className="mb-4">
                  ...
                  * 할인 예상 금액이며, 실제 할인은 결제 페이지에서 적용됩니다.
                 </p>
               </div>
               <div className="border-t pt-4">
                 ...
                 <div className="flex justify-between mb-2">
                   ...
                   <span className="text-blue-500">
                     {discountAmount > 0 ? `- ${discountAmount.toLocaleString()} 원` : '0 원'}
                   </span>
                 </div>
                 <div className="flex justify-between mb-2">
                   <span>배송비</span>
